...
!Define_SMAS_Global_DisableCopyDetection = !FALSE
	...
	%SetROMToAssembleForHack(SMB3_E, !ROMID)
endmacro
...
macro SMB3_GlobalAssemblySettings()
	...
	!Define_Global_BaseROMMD5Hash = "441644baec6d59192c03ca07d46fb3b5"
...
%BANK_START(!BANK_0F)
	...
	%FREE_BYTES(NULLROM, 1, $FF)
		%ROUTINE_RT00_SMB3_UploadMusicBank($0F8B49)
		%ROUTINE_RT01_SMB3_UploadMusicBank($0F8B65)
